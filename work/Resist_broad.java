    ...
    public static void main(String[] args){
        for(int n=0; n<1; n++){
            ...
            try (BufferedReader reader = new BufferedReader(new InputStreamReader(
                    new FileInputStream("./"+String.valueOf(n+1)+"/initial_pos_broad.csv"), Charset.forName("Shift-JIS")))) {
            ...
            try{
                FileWriter f = new FileWriter("./"+String.valueOf(n+1)+"/csv_broad/step0.csv");
                ...
                FileWriter percent_recorder = new FileWriter("./"+String.valueOf(n+1)+"/percent_broad/percent.csv");
                ...
                for(int i=0; i<Constants.T_max; i++){
                    ...
                    fw[i] = new FileWriter("./"+String.valueOf(n+1)+"/csv_broad/step"+String.valueOf(i+1)+".csv");
                    for (int j=0; j<Constants.AGENT_NUM; j++){
                        ag = numberMap.get(j);
                ...
                for(int k=0; k<Constants.N; k++){
                    for(int s=0; s<Constants.M; s++){
                        System.out.print(grid.filled[k][s]);
                    }
                    System.out.println();
                }
                System.out.println();
